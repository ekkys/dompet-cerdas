...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/img/favicon') }}"rel="icon">
    <link href="{{ asset('assets/img/apple-touch-icon') }}"rel="apple-touch-icon">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets/img/product-4.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets/img/product-5.jpg') }}"
                                                            alt=""></a></th>
